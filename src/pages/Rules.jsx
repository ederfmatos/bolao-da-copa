...
import { SCORER_DEADLINE, BRACKET_DEADLINE } from '../lib/bracketData'
...
function Rules() {
  const scenarios = [
    ...
    },
    {
      ...
      description: 'Acertar o vencedor e errar apenas 1 gol (de qualquer time)',
      example: 'Palpite: 4×0 | Resultado: 5×0 · Palpite: 2×1 | Resultado: 2×0',
    },
    {
      points: 6,
