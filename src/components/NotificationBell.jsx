...
function NotificationBell() {
  ...
  const { notifications, unreadCount, loading, markAsRead, markAllAsRead, clearAll } = useNotificationHistory()
              ...
              {loading ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-gray-400 dark:text-dark-muted mt-1">
                    Ative as notificações no perfil para receber atualizações
                  </p>
                </div>
              ) : (
