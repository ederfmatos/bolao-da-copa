...
('5', 'Austrália', 'Turquia', '🇦🇺', '🇹🇷', 'Grupo E', '2026-06-14T04:00:00Z', 'scheduled'),
...
('9', 'Alemanha', 'Curaçao', '🇩🇪', '🇨🇼', 'Grupo F', '2026-06-14T17:00:00Z', 'scheduled'),
('10', 'Países Baixos', 'Japão', '🇳🇱', '🇯🇵', 'Grupo F', '2026-06-14T20:00:00Z', 'scheduled'),
('11', 'Costa do Marfim', 'Equador', '🇨🇮', '🇪🇨', 'Grupo G', '2026-06-14T23:00:00Z', 'scheduled'),
('12', 'Suécia', 'Tunísia', '🇸🇪', '🇹🇳', 'Grupo G', '2026-06-15T02:00:00Z', 'scheduled'),
('13', 'Espanha', 'Cabo Verde', '🇪🇸', '🇨🇻', 'Grupo H', '2026-06-15T17:00:00Z', 'scheduled'),
('14', 'Bélgica', 'Egito', '🇧🇪', '🇪🇬', 'Grupo I', '2026-06-15T22:00:00Z', 'scheduled'),
('15', 'Arábia Saudita', 'Uruguai', '🇸🇦', '🇺🇾', 'Grupo H', '2026-06-15T22:00:00Z', 'scheduled'),
('16', 'Irã', 'Nova Zelândia', '🇮🇷', '🇳🇿', 'Grupo I', '2026-06-16T04:00:00Z', 'scheduled'),
('17', 'França', 'Senegal', '🇫🇷', '🇸🇳', 'Grupo J', '2026-06-16T19:00:00Z', 'scheduled'),
('18', 'Iraque', 'Noruega', '🇮🇶', '🇳🇴', 'Grupo J', '2026-06-16T22:00:00Z', 'scheduled'),
('19', 'Argentina', 'Argélia', '🇦🇷', '🇩🇿', 'Grupo K', '2026-06-17T01:00:00Z', 'scheduled'),
('20', 'Áustria', 'Jordânia', '🇦🇹', '🇯🇴', 'Grupo K', '2026-06-17T04:00:00Z', 'scheduled'),
('21', 'Portugal', 'RD Congo', '🇵🇹', '🇨🇩', 'Grupo L', '2026-06-17T17:00:00Z', 'scheduled'),
('22', 'Inglaterra', 'Croácia', '🏴󠁧󠁢󠁥󠁮󠁧󠁿', '🇭🇷', 'Grupo L', '2026-06-17T20:00:00Z', 'scheduled'),
('23', 'Gana', 'Panamá', '🇬🇭', '🇵🇦', 'Grupo E', '2026-06-17T23:00:00Z', 'scheduled'),
('24', 'Uzbequistão', 'Colômbia', '🇺🇿', '🇨🇴', 'Grupo D', '2026-06-18T02:00:00Z', 'scheduled'),
...
('32', 'Turquia', 'Paraguai', '🇹🇷', '🇵🇾', 'Grupo E', '2026-06-20T04:00:00Z', 'scheduled'),
('33', 'Países Baixos', 'Suécia', '🇳🇱', '🇸🇪', 'Grupo F', '2026-06-20T17:00:00Z', 'scheduled'),
('34', 'Alemanha', 'Costa do Marfim', '🇩🇪', '🇨🇮', 'Grupo F', '2026-06-20T20:00:00Z', 'scheduled'),
('35', 'Equador', 'Curaçao', '🇪🇨', '🇨🇼', 'Grupo G', '2026-06-21T00:00:00Z', 'scheduled'),
('36', 'Tunísia', 'Japão', '🇹🇳', '🇯🇵', 'Grupo G', '2026-06-21T04:00:00Z', 'scheduled'),
('37', 'Espanha', 'Arábia Saudita', '🇪🇸', '🇸🇦', 'Grupo H', '2026-06-21T16:00:00Z', 'scheduled'),
('38', 'Bélgica', 'Irã', '🇧🇪', '🇮🇷', 'Grupo I', '2026-06-21T19:00:00Z', 'scheduled'),
('39', 'Uruguai', 'Cabo Verde', '🇺🇾', '🇨🇻', 'Grupo H', '2026-06-21T22:00:00Z', 'scheduled'),
('40', 'Nova Zelândia', 'Egito', '🇳🇿', '🇪🇬', 'Grupo I', '2026-06-22T01:00:00Z', 'scheduled'),
('41', 'Argentina', 'Áustria', '🇦🇷', '🇦🇹', 'Grupo K', '2026-06-22T17:00:00Z', 'scheduled'),
('42', 'França', 'Iraque', '🇫🇷', '🇮🇶', 'Grupo J', '2026-06-22T21:00:00Z', 'scheduled'),
('43', 'Noruega', 'Senegal', '🇳🇴', '🇸🇳', 'Grupo J', '2026-06-23T00:00:00Z', 'scheduled'),
('44', 'Jordânia', 'Argélia', '🇯🇴', '🇩🇿', 'Grupo K', '2026-06-23T03:00:00Z', 'scheduled'),
('45', 'Portugal', 'Uzbequistão', '🇵🇹', '🇺🇿', 'Grupo L', '2026-06-23T17:00:00Z', 'scheduled'),
('46', 'Inglaterra', 'Gana', '🏴󠁧󠁢󠁥󠁮󠁧󠁿', '🇬🇭', 'Grupo L', '2026-06-23T20:00:00Z', 'scheduled'),
('47', 'Panamá', 'Croácia', '🇵🇦', '🇭🇷', 'Grupo E', '2026-06-23T23:00:00Z', 'scheduled'),
('48', 'Colômbia', 'RD Congo', '🇨🇴', '🇨🇩', 'Grupo D', '2026-06-24T02:00:00Z', 'scheduled'),
...
('55', 'Equador', 'Alemanha', '🇪🇨', '🇩🇪', 'Grupo G', '2026-06-25T20:00:00Z', 'scheduled'),
('56', 'Curaçao', 'Costa do Marfim', '🇨🇼', '🇨🇮', 'Grupo G', '2026-06-25T20:00:00Z', 'scheduled'),
...
('60', 'Paraguai', 'Austrália', '🇵🇾', '🇦🇺', 'Grupo E', '2026-06-26T02:00:00Z', 'scheduled'),
('61', 'Noruega', 'França', '🇳🇴', '🇫🇷', 'Grupo J', '2026-06-26T19:00:00Z', 'scheduled'),
('62', 'Senegal', 'Iraque', '🇸🇳', '🇮🇶', 'Grupo J', '2026-06-26T19:00:00Z', 'scheduled'),
...
('65', 'Egito', 'Irã', '🇪🇬', '🇮🇷', 'Grupo I', '2026-06-27T03:00:00Z', 'scheduled'),
('66', 'Nova Zelândia', 'Bélgica', '🇳🇿', '🇧🇪', 'Grupo I', '2026-06-27T03:00:00Z', 'scheduled'),
('67', 'Panamá', 'Inglaterra', '🇵🇦', '🏴󠁧󠁢󠁥󠁮󠁧󠁿', 'Grupo E', '2026-06-27T21:00:00Z', 'scheduled'),
('68', 'Croácia', 'Gana', '🇭🇷', '🇬🇭', 'Grupo E', '2026-06-27T21:00:00Z', 'scheduled'),
('69', 'Colômbia', 'Portugal', '🇨🇴', '🇵🇹', 'Grupo D', '2026-06-27T23:30:00Z', 'scheduled'),
('70', 'RD Congo', 'Uzbequistão', '🇨🇩', '🇺🇿', 'Grupo D', '2026-06-27T23:30:00Z', 'scheduled'),
('71', 'Argélia', 'Áustria', '🇩🇿', '🇦🇹', 'Grupo K', '2026-06-28T02:00:00Z', 'scheduled'),
('72', 'Jordânia', 'Argentina', '🇯🇴', '🇦🇷', 'Grupo K', '2026-06-28T02:00:00Z', 'scheduled'),
